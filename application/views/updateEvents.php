...
<div class="profile-form row">
      	<form id="updateEventForm" method="post" enctype="multipart/form-data">
      		<div class="input-field col s12 m12" id="eventImage">   
      		 <img  src="<?php echo base_url(); ?>html/images/events/<?php echo $image; ?>" class="profile-img">
      		</div>
      		<div class="input-field col s12 m12" id="eventImage">      			
	           <input type="file" name="image" id="image" style="display:none;">
          	 <button type="button" onclick="$('#eventImage input').click()" class="btn black"> Event Image</button>
